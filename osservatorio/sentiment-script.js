...
$( document ).ready(function() {
  ...
  reserchesstring = "120"; //getUrlParameter("researches");
    ...
    */
    ...
    $("#exportData1").attr("href","https://ia.italia.it/ai-observatory/data/sentimenttimelinepositive.json" );
    $("#exportData2").attr("href","https://ia.italia.it/ai-observatory/data/sentimenttimelinenegative.json" );
    $("#exportData3").attr("href","https://ia.italia.it/ai-observatory/data/sentimenttimelineneutral.json" );
...
function getSentiment(){
    ...
    $.getJSON("https://ia.italia.it/ai-observatory/data/sentiment.json")
    .done(function(data){
...
function getSentimentTimeline(){
    ...
    $.each(sentimentnames, function (i, name) {
        ...
        $.getJSON("https://ia.italia.it/ai-observatory/data/sentimenttimeline" + name.toLowerCase() + ".json" , function(data){
